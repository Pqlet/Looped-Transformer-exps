...
def main():
    ...
    # SPECIFY THE LOGGED RUN !
    # run_id = '0727121059-LR_baseline-5da0' # '0727121059-LR_baseline-5da0' 
    run_id = '0803163324-LR_baseline-n_embd=128-f5e0' # '0727121059-LR_baseline-5da0' 
    n_positions = 101
    n_embd = 128 # 256
    n_layer = 20 # 20
    n_head = 8
    ...
    # SPECIFY THE LOGGED RUN !
    # run_id = '0728104204-LR_loop_L1_ends{30}_T{15}-77c6' # '0728104204-LR_loop_L1_ends{30}_T{15}-77c6'
    run_id = "0803190011-LR_loop_L1_ends{100}_T{20}-6c9b" # '0728104204-LR_loop_L1_ends{30}_T{15}-77c6'
    n_positions = 101
    n_embd = 128
    n_head = 8
    n_layer = 1
