...
class TransformerModelLooped(TransformerModel):
    ...
    def forward(self, xs, ys, loops_calculate_grads, n_loops):
        """
        :param xs: [B, n, d]
        :param ys: [B, n]
        :param loops_calculate_grads: List[int]
        :param n_loops: int
        :return:
        """
        B, n, d_in = xs.shape
        ...
        for idx in range(n_loops):
            if idx in loops_calculate_grads:  # this will save memory when n_loops large.
                with torch.no_grad():
